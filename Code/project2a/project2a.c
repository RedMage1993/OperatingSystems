...
// This is a modified version (of project2b)
// with less features (intermediate sub).
//
// Please read note under History section.
// Thank you.
//******************************************
...
// History
//
// NOTE: Because backspace/delete and left/right aren't handled
// in this version, the cycle feature is out of sync when the
// keys are pressed! The final version does not suffer from this
//
...
//
// Commands
//  - 9/10: Accept commands; exit -- NOTE: You may have to exit
// with Ctrl+C.
...
int main()
{
    ...
    char **arguments;
    int argc; // Number of commands, arguments (for indexes).
    pid_t pid = 0;
    int status;
